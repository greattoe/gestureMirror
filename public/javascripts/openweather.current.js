...
var cityID  = "1835848";	// Seoul, KOREA
var appKey  = "";			// use your own api-key which get from openweathermap
var url = "http://" + baseURL + "id=" + cityID + "&appid=" + appKey;
var temp;					// for temperature
var num;					// for weather number
var icon;					// for weather icon
...
get_weather();
window.setInterval(get_weather, 6000);	// get currunt weather every 6 seconds
										// have to keep under 60 times / min
										// to use weather API for free